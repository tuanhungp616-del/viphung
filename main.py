...
def v67_predict(kq_list):
    ...
    # ... (thuật toán V67 tự nhận sai → đảo cầu tự động)
    return "TÀI", round(random.uniform(96.5, 99.9), 1), "V67 QUANTUM CORE"

@app.get("/api/scan")
async def scan_game(tool: str):
    ...
    try:
        ...
        if not url:
            raise Exception("Tool không hỗ trợ")
...
if __name__ == "__main__":
    print("🚀 DORAEMON V67 TOOL - ĐÃ LẤY PHIEN TỪ LÕI PYTHON")
